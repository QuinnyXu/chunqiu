...
<p align="center">
  <img src="site/assets/og/og-card.png" alt="春秋人物志——左传与国语中的人物、时间线与地图" width="600">
</p>
...
- **数据**（`data/csv/`、`site/data/*.json`）—— [CC BY 4.0](DATA_LICENSE.md)（署名建议格式："春秋人物志 · chunqiu.timechorus.com"）
