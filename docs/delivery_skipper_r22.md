...
5. **层标补齐批（余10条，r22 收尾追加，见 `docs/delivery_skipper_r22b.md`）**：Vision r22 走查发现编者层标机制以 `modern_note` 首字符【…】触发，round22 九条（Q227/Q153/Q155/Q179/Q173/Q174/Q175/Q176/Q215）已按 Sophia 给定文本首插层标落库，`诗歌`/`经义异闻` 两档结构式软检警告由 21 条（真实缺口 71 条，本节仅数首批两档）降至 10 条，余下 10 条**非简单首插可解决**、本轮未处理：
   - **Q133/Q134/Q136/Q144**（经义异闻档）：`modern_note` 已有他人写好的括注体处置说明（如 Q133/Q134「（经义／异闻层·史实可靠度低于左传经传）」、Q136「（先秦诸子·法家寓言·T 层，reliability low）」），要满足"首字符起以【】开头"须**重排既有正文**（把括注内容移到句首改写为【】形式），不是单纯在句首插入四个字就能解决，涉及改写他人已有表述，本轮不擅动。
   - **Q017/Q018/Q019**（诗歌档）：`modern_note` 原文极短，若只在句首插【层标】、句尾维持原样，footer 会显得头重脚轻（层标占大半、正文几乎空掉），须连正文一并补写扩展，不是首插可解决的孤立操作。
